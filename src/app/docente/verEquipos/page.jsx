...
function Page() {
        ...
        const fetchData = async () => {
            try {
                const asignaturasResponse = await fetch(
                    "https://td-g-production.up.railway.app/usuario-asignatura/GroupsDocente/61560"
                ).then((res) => res.json());
    ...
    return (
        <div className="p-6">
            <h1 className="text-3xl font-bold text-gray-800 mb-6">Equipos de mis asignaturas</h1>
